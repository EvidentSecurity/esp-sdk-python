...
class ComplianceStandard(BaseObject):
    ...
    """
    def __init__(self, id=None, name=None, created_at=None, description=None, updated_at=None, compliance_domains=None, compliance_domain_ids=None, compliance_controls=None, compliance_control_ids=None):
        """
