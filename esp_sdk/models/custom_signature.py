...
class CustomSignature(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, description=None, identifier=None, name=None, resolution=None, risk_level=None, updated_at=None, organization=None, organization_id=None, teams=None, team_ids=None, external_accounts=None, external_account_ids=None, definitions=None, definition_ids=None):
        """
