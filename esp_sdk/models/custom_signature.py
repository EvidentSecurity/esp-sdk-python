...
class CustomSignature(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, description=None, identifier=None, include_new_accounts=None, name=None, resolution=None, risk_level=None, updated_at=None, organization=None, organization_id=None, external_accounts=None, external_account_ids=None, definitions=None, definition_ids=None, suppressions=None, suppression_ids=None, service=None, service_id=None):
        """
