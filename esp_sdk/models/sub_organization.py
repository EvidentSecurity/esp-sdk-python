...
class SubOrganization(BaseObject):
    ...
    """
    def __init__(self, id=None, name=None, created_at=None, updated_at=None, external_accounts=None, external_account_ids=None, organization=None, organization_id=None, teams=None, team_ids=None, errors=None):
        """
