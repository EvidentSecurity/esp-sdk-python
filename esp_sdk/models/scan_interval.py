...
class ScanInterval(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, interval=None, updated_at=None, external_account=None, external_account_id=None, service=None, service_id=None, errors=None):
        """
