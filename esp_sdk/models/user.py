...
class User(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, email=None, time_zone=None, first_name=None, last_name=None, phone=None, mfa_enabled=None, disable_daily_emails=None, locked=None, locked_at=None, updated_at=None, organization=None, organization_id=None, sub_organizations=None, sub_organization_ids=None, teams=None, team_ids=None, role=None, role_id=None, errors=None):
        """
