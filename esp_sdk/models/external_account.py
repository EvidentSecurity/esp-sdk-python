...
class ExternalAccount(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, name=None, updated_at=None, provider=None, team=None, team_id=None, scan_intervals=None, scan_interval_ids=None, disabled_signatures=None, disabled_signature_ids=None, azure_group=None, azure_group_id=None, credentials=None, credentials_id=None):
        """
    ...
    @property
    def azure_group_id(self):
        """
        Gets the azure_group_id of this ExternalAccount.
        Associated Azure Group ID

        :return: The azure_group_id of this ExternalAccount.
        :rtype: int
        """
        return self._azure_group_id

    @azure_group_id.setter
    def azure_group_id(self, azure_group_id):
        """
        Sets the azure_group_id of this ExternalAccount.
        Associated Azure Group ID

        :param azure_group_id: The azure_group_id of this ExternalAccount.
        :type: int
        """
