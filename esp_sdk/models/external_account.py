...
class ExternalAccount(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, name=None, updated_at=None, provider=None, arn=None, account=None, external_id=None, cloudtrail_name=None, organization=None, organization_id=None, sub_organization=None, sub_organization_id=None, team=None, team_id=None, scan_intervals=None, scan_interval_ids=None, disabled_signatures=None, disabled_signature_ids=None, credentials=None, credentials_id=None):
        """
