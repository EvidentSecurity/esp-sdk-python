...
class StatCustomSignature(BaseObject):
    ...
    def new_1h_pass(self, new_1h_pass):
        ...
        :type: int
        """
        if new_1h_pass is None:
            raise ValueError("Invalid value for `new_1h_pass`, must not be `None`")
    ...
    def new_1d_pass(self, new_1d_pass):
        ...
        :type: int
        """
        if new_1d_pass is None:
            raise ValueError("Invalid value for `new_1d_pass`, must not be `None`")
    ...
    def new_1w_pass(self, new_1w_pass):
        ...
        :type: int
        """
        if new_1w_pass is None:
            raise ValueError("Invalid value for `new_1w_pass`, must not be `None`")
    ...
    def old_pass(self, old_pass):
        ...
        """
        if old_pass is None:
            raise ValueError("Invalid value for `old_pass`, must not be `None`")
    ...
    def new_1h_fail(self, new_1h_fail):
        ...
        :type: int
        """
        if new_1h_fail is None:
            raise ValueError("Invalid value for `new_1h_fail`, must not be `None`")
    ...
    def new_1d_fail(self, new_1d_fail):
        ...
        :type: int
        """
        if new_1d_fail is None:
            raise ValueError("Invalid value for `new_1d_fail`, must not be `None`")
    ...
    def new_1w_fail(self, new_1w_fail):
        ...
        :type: int
        """
        if new_1w_fail is None:
            raise ValueError("Invalid value for `new_1w_fail`, must not be `None`")
    ...
    def old_fail(self, old_fail):
        ...
        """
        if old_fail is None:
            raise ValueError("Invalid value for `old_fail`, must not be `None`")
    ...
    def new_1h_warn(self, new_1h_warn):
        ...
        :type: int
        """
        if new_1h_warn is None:
            raise ValueError("Invalid value for `new_1h_warn`, must not be `None`")
    ...
    def new_1d_warn(self, new_1d_warn):
        ...
        :type: int
        """
        if new_1d_warn is None:
            raise ValueError("Invalid value for `new_1d_warn`, must not be `None`")
    ...
    def new_1w_warn(self, new_1w_warn):
        ...
        :type: int
        """
        if new_1w_warn is None:
            raise ValueError("Invalid value for `new_1w_warn`, must not be `None`")
    ...
    def old_warn(self, old_warn):
        ...
        """
        if old_warn is None:
            raise ValueError("Invalid value for `old_warn`, must not be `None`")
    ...
    def new_1h_error(self, new_1h_error):
        ...
        :type: int
        """
        if new_1h_error is None:
            raise ValueError("Invalid value for `new_1h_error`, must not be `None`")
    ...
    def new_1d_error(self, new_1d_error):
        ...
        :type: int
        """
        if new_1d_error is None:
            raise ValueError("Invalid value for `new_1d_error`, must not be `None`")
    ...
    def new_1w_error(self, new_1w_error):
        ...
        :type: int
        """
        if new_1w_error is None:
            raise ValueError("Invalid value for `new_1w_error`, must not be `None`")
    ...
    def old_error(self, old_error):
        ...
        if old_error is None:
            raise ValueError("Invalid value for `old_error`, must not be `None`")
    ...
    def suppressed_pass(self, suppressed_pass):
        ...
        :type: int
        """
        if suppressed_pass is None:
            raise ValueError("Invalid value for `suppressed_pass`, must not be `None`")
    ...
    def suppressed_fail(self, suppressed_fail):
        ...
        :type: int
        """
        if suppressed_fail is None:
            raise ValueError("Invalid value for `suppressed_fail`, must not be `None`")
    ...
    def suppressed_warn(self, suppressed_warn):
        ...
        :type: int
        """
        if suppressed_warn is None:
            raise ValueError("Invalid value for `suppressed_warn`, must not be `None`")
    ...
    def suppressed_error(self, suppressed_error):
        ...
        :type: int
        """
        if suppressed_error is None:
            raise ValueError("Invalid value for `suppressed_error`, must not be `None`")
    ...
    def new_1h_info(self, new_1h_info):
        ...
        :type: int
        """
        if new_1h_info is None:
            raise ValueError("Invalid value for `new_1h_info`, must not be `None`")
    ...
    def new_1d_info(self, new_1d_info):
        ...
        :type: int
        """
        if new_1d_info is None:
            raise ValueError("Invalid value for `new_1d_info`, must not be `None`")
    ...
    def new_1w_info(self, new_1w_info):
        ...
        :type: int
        """
        if new_1w_info is None:
            raise ValueError("Invalid value for `new_1w_info`, must not be `None`")
    ...
    def old_info(self, old_info):
        ...
        """
        if old_info is None:
            raise ValueError("Invalid value for `old_info`, must not be `None`")
    ...
    def suppressed_info(self, suppressed_info):
        ...
        :type: int
        """
        if suppressed_info is None:
            raise ValueError("Invalid value for `suppressed_info`, must not be `None`")
    ...
    def custom_signature(self, custom_signature):
        ...
        if custom_signature is None:
            raise ValueError("Invalid value for `custom_signature`, must not be `None`")
    ...
    def custom_signature_id(self, custom_signature_id):
        ...
        :type: int
        """
        if custom_signature_id is None:
            raise ValueError("Invalid value for `custom_signature_id`, must not be `None`")
