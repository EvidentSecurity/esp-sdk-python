...
class Organization(BaseObject):
    ...
    """
    def __init__(self, id=None, name=None, created_at=None, updated_at=None, subscription=None, subscription_id=None, custom_signatures=None, custom_signature_ids=None, external_accounts=None, external_account_ids=None, sub_organizations=None, sub_organization_ids=None, teams=None, team_ids=None, users=None, user_ids=None, compliance_standards=None, compliance_standard_ids=None, integrations=None, integration_ids=None, errors=None):
        """
