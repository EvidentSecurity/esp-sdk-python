...
class Organization(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, enable_new_signatures=None, name=None, require_mfa=None, updated_at=None, subscription=None, subscription_id=None, custom_signatures=None, custom_signature_ids=None, external_accounts=None, external_account_ids=None, sub_organizations=None, sub_organization_ids=None, teams=None, team_ids=None, users=None, user_ids=None, compliance_standards=None, compliance_standard_ids=None, integrations=None, integration_ids=None):
        """
        ...
        self._enable_new_signatures = enable_new_signatures
        self._name = name
    ...
    @property
    def enable_new_signatures(self):
        """
        Gets the enable_new_signatures of this Organization.
        Whether new signatures should be enabled for all accounts on this organization

        :return: The enable_new_signatures of this Organization.
        :rtype: bool
        """
        return self._enable_new_signatures

    @enable_new_signatures.setter
    def enable_new_signatures(self, enable_new_signatures):
        """
        Sets the enable_new_signatures of this Organization.
        Whether new signatures should be enabled for all accounts on this organization

        :param enable_new_signatures: The enable_new_signatures of this Organization.
        :type: bool
        """
