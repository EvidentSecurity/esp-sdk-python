...
class ComplianceControl(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, name=None, identifier=None, description=None, updated_at=None, position=None, compliance_standard=None, compliance_standard_id=None, compliance_domain=None, compliance_domain_id=None, signatures=None, signature_ids=None):
        """
