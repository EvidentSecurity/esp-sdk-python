...
class Team(BaseObject):
    ...
    """
    def __init__(self, id=None, name=None, created_at=None, updated_at=None, custom_signatures=None, custom_signature_ids=None, external_accounts=None, external_account_ids=None, organization=None, organization_id=None, sub_organization=None, sub_organization_id=None, errors=None):
        """
