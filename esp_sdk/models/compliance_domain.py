...
class ComplianceDomain(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, name=None, identifier=None, updated_at=None, position=None, compliance_standard=None, compliance_standard_id=None, compliance_controls=None, compliance_control_ids=None, errors=None):
        """
    ...
    def errors(self):
        """
        Gets the errors of this ComplianceDomain.
        Array of error messages if the request failed

        :return: The errors of this ComplianceDomain.
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        """
        Sets the errors of this ComplianceDomain.
        Array of error messages if the request failed

        :param errors: The errors of this ComplianceDomain.
        :type: list[str]
        """
