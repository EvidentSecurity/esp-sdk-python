...
class Suppression(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, reason=None, resource=None, status=None, suppression_type=None, updated_at=None, organization=None, organization_id=None, created_by=None, created_by_id=None, regions=None, region_ids=None, external_accounts=None, external_account_ids=None, signatures=None, signature_ids=None, custom_signatures=None, custom_signature_ids=None, errors=None):
        """
