...
class CustomSignatureDefinition(BaseObject):
    ...
    """
    def __init__(self, id=None, code=None, created_at=None, language=None, version_number=None, status=None, updated_at=None, custom_signature=None, custom_signature_id=None, results=None, result_ids=None, errors=None):
        """
    ...
    def errors(self):
        """
        Gets the errors of this CustomSignatureDefinition.
        Array of error messages if the request failed

        :return: The errors of this CustomSignatureDefinition.
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        """
        Sets the errors of this CustomSignatureDefinition.
        Array of error messages if the request failed

        :param errors: The errors of this CustomSignatureDefinition.
        :type: list[str]
        """
