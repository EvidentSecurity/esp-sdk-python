...
class Alert(BaseObject):
    ...
    def stated_at(self):
        """
        Gets the stated_at of this Alert.
        ISO 8601 timestamp when the alert started being active

        :return: The stated_at of this Alert.
        :rtype: datetime
        """
        return self._stated_at

    @stated_at.setter
    def stated_at(self, stated_at):
        """
        Sets the stated_at of this Alert.
        ISO 8601 timestamp when the alert started being active

        :param stated_at: The stated_at of this Alert.
        :type: datetime
        """
