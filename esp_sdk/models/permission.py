...
class Permission(BaseObject):
    ...
    """
    def __init__(self, item=None, allowed=None, action=None):
        """
    ...
    def item(self):
        """
        Gets the item of this Permission.
        The Item for the permission

        :return: The item of this Permission.
        :rtype: str
        """
        return self._item
    ...
    def item(self, item):
        """
        Sets the item of this Permission.
        The Item for the permission

        :param item: The item of this Permission.
        :type: str
        """
        if item is None:
    ...
    def allowed(self):
        """
        Gets the allowed of this Permission.
        If the user is allowed to perform the action on the item

        :return: The allowed of this Permission.
        :rtype: bool
        """
    ...
    def allowed(self, allowed):
        """
        Sets the allowed of this Permission.
        If the user is allowed to perform the action on the item

        :param allowed: The allowed of this Permission.
        :type: bool
        """
        if allowed is None:
