...
class Service(BaseObject):
    ...
    """
    def __init__(self, id=None, code=None, created_at=None, default_interval=None, minimum_interval=None, name=None, policy_name=None, updated_at=None, errors=None):
        """
