...
class Report(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, status=None, updated_at=None, organization=None, organization_id=None, sub_organization=None, sub_organization_id=None, team=None, team_id=None, external_account=None, external_account_id=None, alerts=None, alert_ids=None, stat=None, stat_id=None):
        """
