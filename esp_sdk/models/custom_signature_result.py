...
class CustomSignatureResult(BaseObject):
    ...
    """
    def __init__(self, id=None, code=None, created_at=None, error_messages=None, language=None, status=None, updated_at=None, external_account=None, external_account_id=None, region=None, region_id=None, definition=None, definition_id=None, alerts=None, alert_ids=None, errors=None):
        """
        ...
        self.swagger_types = {
            ...
            'definition_id': 'int',
            'alerts': 'list[CustomSignatureResultAlert]',
            'alert_ids': 'list[int]',
            'errors': 'list[str]'
        }
    ...
    def alerts(self):
        ...
        :rtype: list[CustomSignatureResultAlert]
        """
        return self._alerts
    ...
    def alerts(self, alerts):
        ...
        :type: list[CustomSignatureResultAlert]
        """
    ...
    def errors(self):
        """
        Gets the errors of this CustomSignatureResult.
        Array of error messages if the request failed

        :return: The errors of this CustomSignatureResult.
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        """
        Sets the errors of this CustomSignatureResult.
        Array of error messages if the request failed

        :param errors: The errors of this CustomSignatureResult.
        :type: list[str]
        """
