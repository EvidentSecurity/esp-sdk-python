...
class IntegrationAmazonSns(BaseObject):
    ...
    """
    def __init__(self, id=None, topic=None, region_id=None, send_admin_audit_logs=None, created_at=None, updated_at=None, arn=None, external_id=None, region=None, integration=None, integration_id=None):
        """
        ...
        self.attribute_map = {
            ...
            'topic': 'topic',
            'region_id': 'region_id',
            'send_admin_audit_logs': 'send_admin_audit_logs',
        ...
        self._send_admin_audit_logs = send_admin_audit_logs
    ...
    @property
    def send_admin_audit_logs(self):
        """
        Gets the send_admin_audit_logs of this IntegrationAmazonSns.
        Send all Admin Audit Logs

        :return: The send_admin_audit_logs of this IntegrationAmazonSns.
        :rtype: bool
        """
        return self._send_admin_audit_logs

    @send_admin_audit_logs.setter
    def send_admin_audit_logs(self, send_admin_audit_logs):
        """
        Sets the send_admin_audit_logs of this IntegrationAmazonSns.
        Send all Admin Audit Logs

        :param send_admin_audit_logs: The send_admin_audit_logs of this IntegrationAmazonSns.
        :type: bool
        """
