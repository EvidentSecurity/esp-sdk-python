...
class Signature(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, description=None, identifier=None, name=None, resolution=None, updated_at=None, risk_level=None, service=None, service_id=None, disabled_external_accounts=None, disabled_external_accounts_id=None, errors=None):
        """
