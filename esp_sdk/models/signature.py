...
class Signature(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, description=None, identifier=None, name=None, resolution=None, risk_level=None, updated_at=None, service=None, service_id=None, disabled_external_accounts=None, disabled_external_accounts_id=None):
        """
