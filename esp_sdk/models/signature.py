...
class Signature(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, description=None, identifier=None, name=None, resolution=None, risk_level=None, updated_at=None, custom_risk_level=None, service=None, service_id=None, disabled_external_accounts=None, disabled_external_accounts_id=None):
        """
        ...
        self.swagger_types = {
            ...
            'disabled_external_accounts_id': 'int'
        }
        ...
        self._disabled_external_accounts_id = disabled_external_accounts_id
    ...
    @property
    def disabled_external_accounts_id(self):
        """
        Gets the disabled_external_accounts_id of this Signature.
        Associated Disabled External Accounts ID

        :return: The disabled_external_accounts_id of this Signature.
        :rtype: int
        """
        return self._disabled_external_accounts_id

    @disabled_external_accounts_id.setter
    def disabled_external_accounts_id(self, disabled_external_accounts_id):
        """
        Sets the disabled_external_accounts_id of this Signature.
        Associated Disabled External Accounts ID

        :param disabled_external_accounts_id: The disabled_external_accounts_id of this Signature.
        :type: int
        """
