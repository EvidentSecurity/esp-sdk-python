...
class SignatureCustomRiskLevel(BaseObject):
    ...
    """
    def __init__(self, id=None, risk_level=None, created_at=None, updated_at=None, external_account=None, external_account_id=None, signature=None, signature_id=None):
        """
