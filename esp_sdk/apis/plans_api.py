...
class PlansApi(object):
    ...
    def list_with_http_info(self, **kwargs):
        ...
        resource_path = '/api/v2/plans.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/plans/{id}.json_api'.replace('{format}', 'json_api')
        path_params = {}
        if 'id' in params:
