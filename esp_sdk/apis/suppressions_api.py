...
class SuppressionsApi(object):
    ...
    def deactivate_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/suppressions/{id}/deactivate.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def list_with_http_info(self, **kwargs):
        ...
        resource_path = '/api/v2/suppressions.json_api'.replace('{format}', 'json')
        path_params = {}
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/suppressions/{id}.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
