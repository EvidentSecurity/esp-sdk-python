...
class IntegrationsJiraApi(object):
    """
    ...
    def create_with_http_info(self, external_account_ids, issue_type, name, password, project_key, url, username, **kwargs):
        ...
        resource_path = '/api/v2/integrations/jira.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def show_with_http_info(self, integration_id, **kwargs):
        ...
        resource_path = '/api/v2/integrations/{integration_id}/jira.json_api'.replace('{format}', 'json_api')
        path_params = {}
