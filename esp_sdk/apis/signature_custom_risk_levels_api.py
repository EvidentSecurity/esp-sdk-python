...
class SignatureCustomRiskLevelsApi(object):
    ...
    def create_with_http_info(self, external_account_id, risk_level, signature_id, **kwargs):
        ...
        resource_path = '/api/v2/signature_custom_risk_levels.json_api'.replace('{format}', 'json')
        path_params = {}
    ...
    def destroy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/signature_custom_risk_levels/{id}.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def list_with_http_info(self, external_account_id, **kwargs):
        ...
        all_params = ['external_account_id', 'page', 'filter', 'include']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        resource_path = '/api/v2/external_accounts/{external_account_id}/signature_custom_risk_levels.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'external_account_id' in params:
