...
class StatServicesApi(object):
    ...
    def list_for_stat(self, stat_id, **kwargs):
        ...
        :param int stat_id: The ID of the stat to retrieve service statistics for (required)
        :param str include: Related objects that can be included in the response:  service, stat See Including Objects for more information.
    ...
    def show(self, id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Stat Service ID (required)
        :param str include: Related objects that can be included in the response:  service, stat See Including Objects for more information.
        :return: StatService
                 If the method is called asynchronously,
                 returns the request thread.
