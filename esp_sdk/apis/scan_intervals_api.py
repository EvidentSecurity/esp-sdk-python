...
class ScanIntervalsApi(object):
    ...
    def create_with_http_info(self, external_account_id, interval, service_id, **kwargs):
        ...
        resource_path = '/api/v2/scan_intervals.json_api'.replace('{format}', 'json')
        path_params = {}
    ...
    def destroy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/scan_intervals/{id}.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def list_with_http_info(self, external_account_id, **kwargs):
        ...
        resource_path = '/api/v2/external_accounts/{external_account_id}/scan_intervals.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'external_account_id' in params:
