...
class SubscriptionsApi(object):
    ...
    def show(self, id, **kwargs):
        ...
        :param str include: Related objects that can be included in the response:  organization, plan See Including Objects for more information.
        :return: Subscription
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/subscriptions/{id}.json_api'.replace('{format}', 'json_api')
        path_params = {}
        if 'id' in params:
