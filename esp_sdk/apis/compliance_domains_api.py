...
class ComplianceDomainsApi(object):
    """
    ...
    def list(self, **kwargs):
        ...
        :param str include: Objects that can be included in the response:  compliance_standard,compliance_controls  See Including Objects for more information.
    ...
    def list_with_http_info(self, **kwargs):
        ...
        resource_path = '/api/v2/compliance_domains.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def show(self, id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Compliance Domain Id (required)
        :param str include: Objects that can be included in the response:  compliance_standard,compliance_controls  See Including Objects for more information.
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/compliance_domains/{id}.json_api'.replace('{format}', 'json_api')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ComplianceDomain',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
