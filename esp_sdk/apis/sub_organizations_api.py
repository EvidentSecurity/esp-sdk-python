...
class SubOrganizationsApi(object):
    """
    ...
    def create_with_http_info(self, organization_id, name, **kwargs):
        ...
        all_params = ['organization_id', 'name']
        ...
        resource_path = '/api/v2/sub_organizations.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def destroy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/sub_organizations/{id}.json_api'.replace('{format}', 'json_api')
        path_params = {}
        if 'id' in params:
