...
class ExternalAccountsAmazonApi(object):
    """
    ...
    def create(self, arn, external_id, name, team_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(arn, external_id, name, team_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_with_http_info(arn, external_id, name, team_id, **kwargs)
        else:
            (data) = self.create_with_http_info(arn, external_id, name, team_id, **kwargs)
            return data

    def create_with_http_info(self, arn, external_id, name, team_id, **kwargs):
        """
        Create an Amazon External Account
         The related external_account object will be returned with the response.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(arn, external_id, name, team_id, callback=callback_function)
        ...
        all_params = ['arn', 'external_id', 'name', 'team_id']
        ...
        resource_path = '/api/v2/external_accounts/amazon.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def show_with_http_info(self, external_account_id, **kwargs):
        ...
        resource_path = '/api/v2/external_accounts/{external_account_id}/amazon.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def update(self, external_account_id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int external_account_id: The ID of the external account to update an Amazon IAM credential of (required)
        :param str arn: Amazon Resource Name for the IAM role
    ...
    def update_with_http_info(self, external_account_id, **kwargs):
        ...
        all_params = ['external_account_id', 'arn', 'external_id', 'name', 'team_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
