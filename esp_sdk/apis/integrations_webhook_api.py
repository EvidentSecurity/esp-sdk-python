...
class IntegrationsWebhookApi(object):
    """
    ...
    def create_with_http_info(self, external_account_ids, name, throttle_rate, url, **kwargs):
        ...
        resource_path = '/api/v2/integrations/webhook.json_api'.replace('{format}', 'json_api')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        response_type='IntegrationWebhook',
    ...
    def show_with_http_info(self, integration_id, **kwargs):
        ...
        resource_path = '/api/v2/integrations/{integration_id}/webhook.json_api'.replace('{format}', 'json_api')
        path_params = {}
