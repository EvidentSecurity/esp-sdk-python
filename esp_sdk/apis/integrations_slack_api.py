...
class IntegrationsSlackApi(object):
    """
    ...
    def create_with_http_info(self, url, name, external_account_ids, **kwargs):
        ...
        resource_path = '/api/v2/integrations/slack.json_api'.replace('{format}', 'json_api')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        response_type='IntegrationSlack',
    ...
    def show_with_http_info(self, integration_id, **kwargs):
        ...
        resource_path = '/api/v2/integrations/{integration_id}/slack.json_api'.replace('{format}', 'json_api')
        path_params = {}
