...
class StatComplianceControlsApi(object):
    """
    ...
    def list_for_stat(self, stat_id, **kwargs):
        ...
        :param int stat_id: The ID of the stat to retrieve compliance control statistics for (required)
        :param str include: Related objects that can be included in the response:  compliance_control, stat See Including Objects for more information.
    ...
    def show(self, id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Stat Compliance Control ID (required)
        :param str include: Related objects that can be included in the response:  compliance_control, stat See Including Objects for more information.
