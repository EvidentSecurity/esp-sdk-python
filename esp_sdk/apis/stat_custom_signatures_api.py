...
class StatCustomSignaturesApi(object):
    """
    ...
    def list_for_stat(self, stat_id, **kwargs):
        ...
        :param int stat_id: The ID of the stat to retrieve custom signature statistics for (required)
        :param str include: Related objects that can be included in the response:  custom_signature, stat See Including Objects for more information.
    ...
    def show(self, id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Stat Custom Signature ID (required)
        :param str include: Related objects that can be included in the response:  custom_signature, stat See Including Objects for more information.
