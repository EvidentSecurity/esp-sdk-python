...
class ReportsApi(object):
    ...
    def create(self, team_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(team_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int team_id: The ID of the team to create a report for (required)
        :param str include: Related objects that can be included in the response:  organization, sub_organization, team, external_account, stat See Including Objects for more information.
        :return: Report
        ...
        if kwargs.get('callback'):
            return self.create_with_http_info(team_id, **kwargs)
        else:
            (data) = self.create_with_http_info(team_id, **kwargs)
            return data

    def create_with_http_info(self, team_id, **kwargs):
        """
        Create a(n) Report
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(team_id, callback=callback_function)
        ...
        resource_path = '/api/v2/reports.json_api'.replace('{format}', 'json_api')
        path_params = {}
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/reports/{id}.json_api'.replace('{format}', 'json_api')
        path_params = {}
        if 'id' in params:
