...
class TagsApi(object):
    ...
    def list_with_http_info(self, alert_id, **kwargs):
        ...
        all_params = ['alert_id', 'page', 'filter', 'include']
        ...
        resource_path = '/api/v2/alerts/{alert_id}/tags.json_api'.replace('{format}', 'json')
        path_params = {}
    ...
    def show_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/api/v2/tags/{id}.json_api'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
