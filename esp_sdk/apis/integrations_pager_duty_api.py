...
class IntegrationsPagerDutyApi(object):
    """
    ...
    def create_with_http_info(self, api_key, name, external_account_ids, **kwargs):
        ...
        resource_path = '/api/v2/integrations/pager_duty.json_api'.replace('{format}', 'json_api')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        response_type='IntegrationPagerDuty',
    ...
    def show_with_http_info(self, integration_id, **kwargs):
        ...
        resource_path = '/api/v2/integrations/{integration_id}/pager_duty.json_api'.replace('{format}', 'json_api')
        path_params = {}
