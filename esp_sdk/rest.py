...
class RESTClientObject(object):
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        :param body: request json body, for `application/vnd.api+json`
...
class ApiException(Exception):
    ...
    def __reason(self):
        try:
            ...
            body = {}
        message = " ".join([e['title'] for e in body.get('errors', [])])
        if not message:
            message = 'NA'
        return "Failed.  Response code = " + str(self.status) + ".  Response message = " + message
