...
from esp_sdk.apis.service_stats_api import ServiceStatsApi


class TestServiceStatsApi(unittest.TestCase):
    """ ServiceStatsApi unit test stubs """

    def setUp(self):
        self.api = esp_sdk.apis.service_stats_api.ServiceStatsApi()
