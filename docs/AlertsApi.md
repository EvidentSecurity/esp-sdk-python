...
# **list_for_report**
> PaginatedCollection list_for_report(report_id, filter=filter, include=include, page=page)
...
try: 
    # Get a list of Alerts
    api_response = api_instance.list_for_report(report_id, filter=filter, include=include, page=page)
    pprint(api_response)
except ApiException as e:
